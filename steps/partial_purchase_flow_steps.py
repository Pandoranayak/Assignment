...
def validate_api_call(context, api_url, exp_status):
    ...
    try:
        ...
        quantity = post_response_json.get('quantity')
        ...
        result_message = post_response_json.get('result')
        assert result_message == "item added or updated", f"Unexpected result message in POST response: {result_message}"
